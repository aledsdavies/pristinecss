...
*#myid { font-weight: bold; }
    `,
			expected: []parser.Token{
				{Type: parser.SELECTOR, Literal: []byte("*")},
				...
				{Type: parser.SELECTOR, Literal: []byte("*")},
				{Type: parser.SELECTOR, Literal: []byte("::before")},
				{Type: parser.COMMA, Literal: []byte(",")},
				{Type: parser.SELECTOR, Literal: []byte("*")},
				{Type: parser.SELECTOR, Literal: []byte("::after")},
				{Type: parser.LBRACE, Literal: []byte("{")},
				...
				{Type: parser.SELECTOR, Literal: []byte("div")},
				{Type: parser.SELECTOR, Literal: []byte("*")},
				{Type: parser.SELECTOR, Literal: []byte("p")},
				{Type: parser.LBRACE, Literal: []byte("{")},
				...
				{Type: parser.SELECTOR, Literal: []byte("*[lang^=en]")},
				{Type: parser.LBRACE, Literal: []byte("{")},
				{Type: parser.IDENT, Literal: []byte("color")},
				{Type: parser.COLON, Literal: []byte(":")},
				...
				{Type: parser.SELECTOR, Literal: []byte("*.warning")},
				{Type: parser.LBRACE, Literal: []byte("{")},
				{Type: parser.IDENT, Literal: []byte("color")},
				{Type: parser.COLON, Literal: []byte(":")},
				...
				{Type: parser.SELECTOR, Literal: []byte("*#myid")},
				{Type: parser.LBRACE, Literal: []byte("{")},
		...
		},
		{
			...
			expected: []parser.Token{
				...
				{Type: parser.SELECTOR, Literal: []byte("ul")},
				{Type: parser.TILDE, Literal: []byte("~")},
				{Type: parser.SELECTOR, Literal: []byte("span")},
				{Type: parser.LBRACE, Literal: []byte("{")},
				{Type: parser.IDENT, Literal: []byte("color")},
				{Type: parser.COLON, Literal: []byte(":")},
				{Type: parser.IDENT, Literal: []byte("red")},
		...
		},
		{
			...
			expected: []parser.Token{
				{Type: parser.SELECTOR, Literal: []byte("p")},
				{Type: parser.SELECTOR, Literal: []byte("::first-line")},
				{Type: parser.LBRACE, Literal: []byte("{")},
		...
		},
		{
			...
			expected: []parser.Token{
				{Type: parser.SELECTOR, Literal: []byte("h1")},
				{Type: parser.COMMA, Literal: []byte(",")},
				{Type: parser.SELECTOR, Literal: []byte("h2")},
				{Type: parser.COMMA, Literal: []byte(",")},
				{Type: parser.SELECTOR, Literal: []byte("h3")},
				{Type: parser.LBRACE, Literal: []byte("{")},
    ...
    `,
			expected: []parser.Token{
				{Type: parser.SELECTOR, Literal: []byte(":root")},
				{Type: parser.LBRACE, Literal: []byte("{")},
				...
				{Type: parser.SELECTOR, Literal: []byte("li")},
				{Type: parser.SELECTOR, Literal: []byte(":nth-child")},
				...
				{Type: parser.SELECTOR, Literal: []byte("tr")},
				{Type: parser.SELECTOR, Literal: []byte(":nth-child")},
				{Type: parser.LPAREN, Literal: []byte("(")},
    ...
    `,
		...
		},
		{
			...
			expected: []parser.Token{
				{Type: parser.AT_RULE, Literal: []byte("@media")},
		...
		},
		{
			...
			expected: []parser.Token{
				{Type: parser.SELECTOR, Literal: []byte("#main")},
				{Type: parser.GREATER, Literal: []byte(">")},
				{Type: parser.SELECTOR, Literal: []byte(".article")},
				{Type: parser.SELECTOR, Literal: []byte("p")},
				{Type: parser.SELECTOR, Literal: []byte(":first-child")},
				{Type: parser.LBRACE, Literal: []byte("{")},
				{Type: parser.IDENT, Literal: []byte("color")},
				{Type: parser.COLON, Literal: []byte(":")},
...
.custom { border: 1px solid black!important }`,
			expected: []parser.Token{
				...
				{Type: parser.SELECTOR, Literal: []byte(".custom")},
				{Type: parser.LBRACE, Literal: []byte("{")},
		...
		},
		{
			...
			expected: []parser.Token{
				{Type: parser.SELECTOR, Literal: []byte("a[href^=\"https://\"]")},
				{Type: parser.LBRACE, Literal: []byte("{")},
				{Type: parser.IDENT, Literal: []byte("color")},
				{Type: parser.COLON, Literal: []byte(":")},
				{Type: parser.IDENT, Literal: []byte("green")},
		...
		},
		{
			...
			expected: []parser.Token{
				{Type: parser.AT_RULE, Literal: []byte("@keyframes")},
		...
		},
		{
			...
			expected: []parser.Token{
				...
				{Type: parser.SEMICOLON, Literal: []byte(";")},
				{Type: parser.RBRACE, Literal: []byte("}")},
				{Type: parser.SELECTOR, Literal: []byte("body")},
				{Type: parser.LBRACE, Literal: []byte("{")},
				{Type: parser.IDENT, Literal: []byte("color")},
				{Type: parser.COLON, Literal: []byte(":")},
		...
		},
		{
			...
			expected: []parser.Token{
				{Type: parser.SELECTOR, Literal: []byte(".foo\\.bar")},
				{Type: parser.LBRACE, Literal: []byte("{")},
				{Type: parser.IDENT, Literal: []byte("color")},
				{Type: parser.COLON, Literal: []byte(":")},
				{Type: parser.IDENT, Literal: []byte("red")},
		...
		},
		{
			...
			expected: []parser.Token{
				{Type: parser.SELECTOR, Literal: []byte("a[href=\"foo\\\"bar\"]")},
				{Type: parser.LBRACE, Literal: []byte("{")},
				{Type: parser.IDENT, Literal: []byte("color")},
				{Type: parser.COLON, Literal: []byte(":")},
				{Type: parser.IDENT, Literal: []byte("blue")},
...
`,
			expected: []parser.Token{
				...
				{Type: parser.SEMICOLON, Literal: []byte(";")},
				{Type: parser.RBRACE, Literal: []byte("}")},
				{Type: parser.SELECTOR, Literal: []byte(".günther")},
				{Type: parser.COMMA, Literal: []byte(",")},
				{Type: parser.SELECTOR, Literal: []byte("#π_value")},
				{Type: parser.COMMA, Literal: []byte(",")},
				{Type: parser.SELECTOR, Literal: []byte(".こんにちは")},
				{Type: parser.LBRACE, Literal: []byte("{")},
				{Type: parser.IDENT, Literal: []byte("color")},
				{Type: parser.COLON, Literal: []byte(":")},
				{Type: parser.IDENT, Literal: []byte("blue")},
				...
				{Type: parser.SEMICOLON, Literal: []byte(";")},
				{Type: parser.RBRACE, Literal: []byte("}")},
				{Type: parser.SELECTOR, Literal: []byte("#\\26 ABC")},
				{Type: parser.LBRACE, Literal: []byte("{")},
		...
		},
		{
			...
			expected: []parser.Token{
				...
				{Type: parser.SEMICOLON, Literal: []byte(";")},
				{Type: parser.RBRACE, Literal: []byte("}")},
				{Type: parser.SELECTOR, Literal: []byte(".foo")},
				{Type: parser.LBRACE, Literal: []byte("{")},
				{Type: parser.IDENT, Literal: []byte("color")},
				{Type: parser.COLON, Literal: []byte(":")},
				{Type: parser.IDENT, Literal: []byte("var")},
		...
		},
		{
			...
			expected: []parser.Token{
				{Type: parser.SELECTOR, Literal: []byte(".gradient")},
				{Type: parser.LBRACE, Literal: []byte("{")},
    ...
    `,
			...
			expected: []parser.Token{
				...
				{Type: parser.COLON, Literal: []byte(":")},
				{Type: parser.IDENT, Literal: []byte("value")},
				{Type: parser.IDENT, Literal: []byte("\\9")},
				{Type: parser.SEMICOLON, Literal: []byte(";")},
				{Type: parser.RBRACE, Literal: []byte("}")},
...
func TestIllegalCases(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			expected: []parser.Token{
				{Type: parser.SELECTOR, Literal: []byte(".invalid")},
				{Type: parser.LBRACE, Literal: []byte("{")},
				{Type: parser.IDENT, Literal: []byte("color")},
				{Type: parser.COLON, Literal: []byte(":")},
				{Type: parser.SELECTOR, Literal: []byte("#1234ZZ")},
				{Type: parser.SEMICOLON, Literal: []byte(";")},
				{Type: parser.RBRACE, Literal: []byte("}")},
			},
		},
		{
			...
			expected: []parser.Token{
				{Type: parser.SELECTOR, Literal: []byte(".invalid-unit")},
				{Type: parser.LBRACE, Literal: []byte("{")},
				{Type: parser.IDENT, Literal: []byte("width")},
				{Type: parser.COLON, Literal: []byte(":")},
		...
		},
		{
			...
			expected: []parser.Token{
				{Type: parser.SELECTOR, Literal: []byte(".invalid-percentage")},
				{Type: parser.LBRACE, Literal: []byte("{")},
				{Type: parser.IDENT, Literal: []byte("height")},
				{Type: parser.COLON, Literal: []byte(":")},
				{Type: parser.NUMBER, Literal: []byte("100")},
		...
		// You can add more test cases here
		{
			...
			expected: []parser.Token{
				{Type: parser.SELECTOR, Literal: []byte(".invalid-property")},
				{Type: parser.LBRACE, Literal: []byte("{")},
